    ...
    const processes = [
        {
            ...
            quality: "99.5% – 99.9% de pureté",
            applications: "Pharmacie, Cosmétique, Caoutchouc haute performance",
            advantage:
                "Contrôle précis de la pureté et de la taille des particules",
        },
        {
            ...
            advantage: "Coût de production plus compétitif",
        },
        {
            ...
            applications: "Nano-ZnO, Catalyse, Désulfuration",
        ...
        <section className="space-y-10">
            ...
            <header className="max-w-2xl">
                ...
                <p className="text-base-content/70">
                    Comparaison des principales méthodes utilisées dans la
                    production industrielle de l’oxyde de zinc.
                </p>
            </header>
