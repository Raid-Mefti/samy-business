...
function AnimatedCard({ card, color, glow, offset, isRtl, lang }) {
    ...
    // Mirror staircase: step left in Arabic
    const staggerStyle = isLg
        ? isRtl
    ...
    return (
        ...
        >
            {/* TEXT FIRST in JSX for Arabic to achieve image on right without flex-reverse */}
            {isRtl ? (
                <>
                    {/* TEXT - appears on the right in Arabic */}
                    <motion.div
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.97 }}
                            className="btn border-0 text-white font-semibold px-6 py-3 rounded-xl self-end shadow-md "
                            style={{
                    ...
                    {/* IMAGE - appears on the right in Arabic */}
                    <motion.div
                ...
                <>
                    {/* IMAGE - appears on the left in FR/EN */}
                    <motion.div
                        whileHover={{ scale: 1.015 }}
                        transition={{ duration: 0.5, ease: "easeOut" }}
                        className="relative flex-shrink-0 w-full lg:w-[460px] rounded-3xl overflow-hidden shadow-lg "
                    ...
                    {/* TEXT - appears on the right in FR/EN */}
                    <motion.div
                        initial={{ opacity: 0, x: -40 }}
                        animate={inView ? { opacity: 1, x: 0 } : {}}
                        transition={{ delay: 0.5, duration: 1 }}
